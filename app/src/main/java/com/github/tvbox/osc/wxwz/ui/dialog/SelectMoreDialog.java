...
public class SelectMoreDialog<T> extends BaseDialog {

    private boolean muteCheck = false;

    public SelectMoreDialog(@NonNull @NotNull Context context) {
        super(context);
        setContentView(R.layout.dialog_select);
    }

    public SelectMoreDialog(@NonNull @NotNull Context context, int resId) {
        super(context);
