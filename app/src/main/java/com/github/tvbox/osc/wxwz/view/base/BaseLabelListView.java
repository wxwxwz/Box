package com.github.tvbox.osc.wxwz.view.base;
...
import com.github.tvbox.osc.wxwz.inface.ILabelInfo;
...
public abstract class BaseLabelListView<T> extends LinearLayout implements
	...
	private TextView createLabel(final T data, final int position) {
		...
		labelText.setOnLongClickListener(new OnLongClickListener() {
			@Override
			public boolean onLongClick(View v) {
				mIOnItemLongClickListener.onLongClick(getLabelName(data), position);
				return true;
			}
		});
		return labelText;
	...
	public void setOnLongClickListener(IOnItemLongClickListener listener) {
		this.mIOnItemLongClickListener = listener;
	}

	public abstract String getLabelName(GameLabel object);
}
